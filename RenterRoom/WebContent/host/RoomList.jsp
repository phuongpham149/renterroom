	...
	<div id="ajax-content">
		<div class="row">
			<div id="breadcrumb" class="col-xs-12">
				<a class="show-sidebar" href="#"> <i class="fa fa-bars"></i>
				</a>
			...
			<table class="table table-striped table-bordered table-hover"
				...
				%>
					<tr>
						...
						<td>
							<% if (obj.getIsEmpty()==0){ %> <input type="checkbox"
							name="isEmpty" value="<%=obj.getIsEmpty()%>"> <%} if (obj.getIsEmpty()==1) {%>
							<input type="checkbox" name="isEmpty"
							value="<%=obj.getIsEmpty()%>" checked="true"> <%} %>
						</td>
						<td><%=obj.getNameCategory()%></td>
						<td>
							<button value="<%= obj.getIdRoom() %>"
								class="btn btn-default btn-update"
								id="btn-update<%= obj.getIdRoom() %>" data-toggle="modal"
								data-target="#myModalUpdate">
								<i class="fa fa-edit"></i>
							</button>
							<button type="button" id="btn-xoa" class="btn btn-danger"
			...
			<div id="myModalUpdate" class="modal fade" role="dialog">
				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						<form id="form-xoa"
							action="<%=request.getContextPath()%>/RoomUpdateAction"
							method="post">
							<input id="modal-hidden-idRoom" type="hidden" value=""
								name="idRoom" />
